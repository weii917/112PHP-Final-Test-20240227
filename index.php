...
<body>
    ...
    <div id="all">
        ...
        <div id="title2">
            <a href="index.php"><img src="./icon/banner.jpg" title="健康促進網－回首頁"></a>
        </div>
        <div id="mm">
            <div class="hal" id="lef" style="text-align: center;">
            ...
            <div class="hal" id="main">
                <div>
                    <marquee style="width:78%; display:inline-block;">歡迎民眾月投稿電子稿，讓電子報成為大家相互交流、分享的園地!詳見最新文章</marquee>
